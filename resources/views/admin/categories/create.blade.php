                ...
                <div class="col-12 col-lg-8 p-0 main-box">
                    ...
                    <div class="col-12 p-3 row">
                        ...
                        <div class="col-12 col-lg-12 p-2">
                            ...
                            <div class="col-12 pt-3">
                                <textarea name="meta_description" required maxlength="10000" class="form-control"
                        ...
                        <div class="col-12 col-lg-12 p-2">
                            ...
                            <div class="col-12 pt-3">
                            <textarea name="meta_keywords" required maxlength="10000" class="form-control"
                                      style="min-height:150px">{{ old('meta_keywords') }}</textarea>
                            </div>
                        </div>
                        <div class="col-6 p-2">
                            <div class="col-12">

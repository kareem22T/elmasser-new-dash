                ...
                <div class="col-12 col-lg-8 px-3 py-5">
                            ...
                            <div class="col-12 col-lg-9 px-2">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" id="DarkModeInput"
                                        name="dashboard_dark_mode" {{ $settings->dashboard_dark_mode == 1 ? 'checked' : '' }}
                                        value="1">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-12 row p-0 taber" id="pages-tab">
                        ...
                        <div class="col-12 px-0 d-flex mb-3 row pb-3">
                            ...
                            <div class="col-12 col-lg-9 px-2">
                                <textarea name="about_page" class="ckeditor">{!! $settings->about_page !!}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-12 px-0 d-flex mb-3 row pb-3">
                            ...
                            <div class="col-12 col-lg-9 px-2">
                                <textarea name="adsPage" class="ckeditor">{!! $settings->adsPage !!}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-12 px-0 d-flex mb-3 row pb-3">
                            ...
                            <div class="col-12 col-lg-9 px-2">
                                <textarea name="privacy" class="ckeditor">{!! $settings->privacy !!}</textarea>
                            </div>
                        </div>

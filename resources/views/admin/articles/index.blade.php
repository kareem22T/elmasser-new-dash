                    ...
                    <table class="table table-bordered  table-hover">
                        ...
                        @foreach($articles as $article)
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('admin.categories.index',['id'=> $article->category_id])}}"
                                       style="color:#2381c6">{{$article->category->title}}</a>
                                </td>
                                <td>{{$article->slug}}</td>
                                <td><img src="{{$article->main_image()}}" style="width:40px"></td>
                                <td>{{$article->title}}</td>
                                <td>
                                    @if($article->is_urgent==1)
                                ...
                                <td style="width: 360px;">
                                    ...
                                    <a target="_blank" href="{{redirectArticleRoute($article)}}">

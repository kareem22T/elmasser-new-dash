                ...
                <div class="col-12 col-lg-8 p-0 main-box">
                    ...
                    <div class="col-12 p-3 row">
                            ...
                            <div class="col-12 pt-3">
                                <select class="form-control select2-select" name="category_id" required size="1"
                                    ...
                                    @foreach ($categories as $id => $title)
                                        <option value="{{ $id }}"
                                            @if ($id == $article->category_id) selected @endif>{{ $title }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="col-12 pt-3">
                                <select class="form-control select2-select" name="user_id" required size="1"
                                    ...
                                    @foreach ($users as $id => $name)
                                        <option value="{{ $id }}"
                                            @if ($id == $article->user_id) selected @endif>{{ $name }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="col-12 pt-3">
                                <select class="form-control select2-select-tags" name="tags[]" multiple size="1"
                                    ...
                                    @foreach ($tags as $id => $tag_name)
                                        <option value="{{ $id }}"
                                            @if (in_array($id, $article->tags->pluck('id')->toArray())) selected @endif>{{ $tag_name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-6 p-2">
                            ...
                            <div class="col-12 pt-3">
                                <input value="{{ $article->getOriginal('main_image') }}" readonly type="text" class="form-control" id="main_image" name="main_image">
                            </div>
                        ...
                        <div class="col-6  p-2">
                            ...
                            <div class="col-12 pt-3">
                                <input type="text" name="main_image_title" maxlength="190" class="form-control" value="{{ $article->main_image_title }}">
                            </div>
                        </div>
                        ...
                        <div class="col-12  p-2">
                            ...
                            <div class="col-12 pt-3">
                                <textarea name="description" class="ckeditor">{{ $article->description }}</textarea>
                            </div>
                        </div>
                        {{--<div class="col-12 col-lg-12 p-2">
                            <div class="col-12">
                        ...
                        <div class="col-6 p-2">
                            ...
                            <div class="col-12 pt-3">
                                <select class="form-control" name="is_urgent">
                                    <option @if ($article->is_urgent == '0') selected @endif value="0">لا</option>
                                    <option @if ($article->is_urgent == '1') selected @endif value="1">نعم</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-6 p-2">

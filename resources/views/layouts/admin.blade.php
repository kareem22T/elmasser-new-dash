...
<head>
    ...
    <link rel="stylesheet" type="text/css"
          href="https://cdnjs.cloudflare.com/ajax/libs/jquery.colorbox/1.4.33/example3/colorbox.min.css">
                        ...
                        <div class="col-12 px-0">
                            <ul class="sub-item font-1" style="list-style:none;">
                                ...
                                <li><a href="{{ route('admin.categories.index') }}"
                                       style="font-size: 16px;"><span class="fal fa-tag px-2"
                                ...
                                <li><a href="{{ route('admin.prices.index') }}"
                                       style="font-size: 16px;"><span class="fal fa-money-bill px-2"
                                                                      style="width: 28px;font-size: 15px;"></span> اسعار
                                        اليوم
                                    </a></li>
                                ...
                                <li><a href="{{ route('admin.surveys.index') }}" style="font-size: 16px;"><span
                                            class="fal fa-question px-2"
                                            style="width: 28px;font-size: 15px;"></span> الاستطلاعات
                                    </a></li>
                                @endpermission
                ...
                <div class="btn-group" id="notificationDropdown">
                    ...
                    <div class="col-12 px-0 d-flex justify-content-center align-items-center btn  "
                        ...
                        <span
                            ...
                            @else
                            display: none; @endif
                            right: 0px;top: 0px;border-radius: 20px;background: #c00;color:var(--background-1);font-size: 14px;"

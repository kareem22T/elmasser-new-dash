@extends('layouts.app', ['page_title' => $category->title, 'seo_meta_description' => $category->meta_description, 'seo_key_words' => $category->meta_keywords])
@section('content')
@if($articles)
...
<img src="{{ asset('assets2/imgs/home-maser-outer.jpg') }}" alt="" class="ad">
    <div class="container">
        ...
        <div class="container" dir="rtl">
            <h1 class="cateory_head">{{ $category->title}}</h1>
            <p class="category_desc">{{ ($category && $category?->meta_description) ?  $category?->meta_description : ''}}</p>
        </div>

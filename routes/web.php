...
Route::prefix('admin')->middleware(['auth','ActiveAccount'])->name('admin.')->group(function () {
    ...
    Route::middleware('auth')->group(function () {
        ...
        Route::post('surveys/order',[SurveyController::class,'order'])->name('surveys.order');
...
Route::get('section/{category}/{slug?}',[FrontController::class,'category'])->name('category.show');
Route::get('section/{category}/{slug?}/rss-feed',[FrontController::class,'categoryRssFeed'])->name('category.rss-feed');
Route::get('author/{user}',[FrontController::class,'author'])->name('author.show');
Route::get('article/{article}/{slug?}',[FrontController::class,'article'])->name('article.show');
Route::get('search',[FrontController::class,'search'])->name('search.show');
...
Route::get('/article/{article}', function(Article $article) {
    return redirect()->to(redirectArticleRoute($article));
});
